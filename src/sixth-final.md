...
제가 `std::collections::LinkedList`를 바닥부터 다시 구현하는 과정에서 보여드린 온갖 사소한 넋두리와 우여곡절을 끝까지 참고 지켜봐 주시다니 정말 믿기지가 않네요.

제가 해냈습니다! 이 책도 끝났으니 이제 드디어 푹 쉴 수 있겠네요.

자, 여기 우리가 함께 완성해 낸 1200줄에 달하는 완벽하고 멋진 전체 코드 내용입니다. 아마 [이 커밋(this commit)](https://github.com/contain-rs/linked-list/commit/5b69cc29454595172a5167a09277660342b78092)의 내용과 완벽히 똑같을 겁니다.

나중에 여유가 생기면 예쁘게 주석(docs)도 달고 다듬어서 0.1.0 버전으로 정식 출간(publish)하겠습니다.
