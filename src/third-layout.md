...
이런 젠장, 뼈 맞았네요 (sick burn). 우리가 가변 리스트를 짤 땐 여태 모든 걸 암묵적인 도구로 꿀 빨며 썼는데 반해, Rc 이녀석은 얼마나 멍청한 찌끄래기인지 세상 모든 Rust 프로그래머의 기본 탑재 도구 목록에서조차 누락될 정도군요. 
